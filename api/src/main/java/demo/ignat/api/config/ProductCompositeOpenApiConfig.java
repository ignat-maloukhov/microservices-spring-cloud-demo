...
@Configuration
@PropertySource(value = "classpath:openapi-properties.yml",
        factory = YamlPropertySourceFactory.class)
//@ComponentScan("demo.ignat")
public class ProductCompositeOpenApiConfig {
    ...
    /**
     * Документация к API доступна по URL $HOST:$PORT/swagger-ui.html
     *
     * @return возвращает объект OpenAPI
     */
    @Bean
